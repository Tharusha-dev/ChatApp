...
export default function RequestsPopup({bufferUsers, socket, setWorkerChats, setBufferUsers}: {
    bufferUsers: any[], 
    socket: Socket, 
    setWorkerChats: any, 
    setBufferUsers: any
    ...
    const handleAccept = (user: any) => {
        setWorkerChats((prevChats: any) => addUniqueUser(prevChats, {
        ...
        socket.emit("worker-buffer-accept", JSON.stringify({
            workerToken: workerToken,
            webToken: user.userToken,
            chatId: user.chatId
        }));
